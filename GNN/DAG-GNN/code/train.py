...
parser.add_argument('--data_dir', type=str, default= './DAG-GNN/data',
                    help='data file name containing the discrete files.')
parser.add_argument('--data_sample_size', type=int, default=5000,
                    help='the number of samples of data')
parser.add_argument('--data_variable_size', type=int, default=8,
...
parser.add_argument('--decoder-dropout', type=float, default=0.0,
                    help='Dropout rate (1 - keep probability).')
parser.add_argument('--save-folder', type=str, default='./DAG-GNN/logs',
...
# Generate relation receiver, relation sender: (num_nodes-1, num_nodes)
"""这种表示方法在图神经网络中非常有用，特别是在处理消息传递或注意力机制时。它允许模型轻松识别每条边的发送和接收节点，便于进行关系推理和图结构学习。"""
